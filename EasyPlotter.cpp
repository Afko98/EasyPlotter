// Copyright (c) 2024 Afko98. All rights reserved.
...
/*    
    ...
    for (x = 1; x <= 10000; ++x) {  // x > 0 because log(x) is undefined for x <= 0
        expression.value();
    }
    std::cout << "x = " << x << ", result = " << expression.value() << "\n";
    return 0;
*/
