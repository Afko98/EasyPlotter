...
Constant::Constant(GraphType graph_type, double amplitude, std::string graph_name, double sample_freq, double x_min, double x_max, std::string label_x, std::string label_y)
