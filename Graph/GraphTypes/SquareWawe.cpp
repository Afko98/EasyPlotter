...
void SquareWawe::calculateGraphData()
{
    ...
    {
        double x = m_base_arg._x_min + i / m_base_arg._sample_frequency;
...
void SquareWawe::renderImGuiEditGraph()
{
    ...
    ImGui::BeginChild(("SquareWave##list" + m_base_arg._graph_name).c_str(), ImVec2(windowSize.x - 500, windowSize.y - 2), true, ImGuiWindowFlags_NoMove);
