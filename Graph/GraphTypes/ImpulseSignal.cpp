...
void ImpulseSignal::calculateGraphData()
{
    ...
    int index_impulse_position = static_cast<int>((-m_base_arg._x_min + m_impulse_position) * m_base_arg._sample_frequency);
...
void ImpulseSignal::renderImGuiEditGraph()
{
    ...
    ImGui::BeginChild(("ImpulseSignal##list" + m_base_arg._graph_name).c_str(), ImVec2(windowSize.x - 500, windowSize.y - 2), true, ImGuiWindowFlags_NoMove);
